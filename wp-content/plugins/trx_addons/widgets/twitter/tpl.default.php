...
?><div class="widget_content">
	<div class="sc_twitter sc_twitter_<?php
				...
				if ($widget_args['slider']) echo ' swiper-slider-container slider_swiper slider_noresize slider_nocontrols '.((int)$widget_args['slider_pagination'] > 0 ? 'slider_pagination' : 'slider_nopagination');
				?>"<?php
			echo ((int)$widget_args['columns'] > 1
						? ' data-slides-per-view="' . esc_attr($widget_args['columns']) . '"' 
						: '')
				. ((int)$widget_args['slides_space'] > 0
	...
	?>><?php
		...
		if ((int)$widget_args['slider'] > 0 && (int)$widget_args['slider_pagination'] > 0) {
