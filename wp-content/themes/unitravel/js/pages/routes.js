document.addEventListener('DOMContentLoaded', function() {
    ...
    jQuery('.media-delete').on('click', async function() {
        Swal.fire({
                title: '¿Estás seguro?',
                ...
                if (result.isConfirmed) {
                    ...
                    let delete_url = customFetch.home_url + "/wp-content/themes/unitravel/includes/form-handlers/delete_media_route.php";
                    let response = await do_post(delete_url, data);
                    jQuery("#custom-loading-overlay").css("display", "none");
    ...
    jQuery("#select-media-type").on("change", () => {
        if(jQuery("#select-media-type").val() == "foto"){
